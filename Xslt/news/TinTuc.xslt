...
<xsl:output method="html" indent="yes"/>
        ...
        <div class="container">
                ...
                <div class="main-content">
                    <div class="content-item active" data-content="1">
                        <div class="row">
                            <xsl:apply-templates select="News" mode="News2a"></xsl:apply-templates>
                        </div>
                    </div>
                    <div class="content-item" data-content="2">
                        <div class="row">
                            <xsl:apply-templates select="News" mode="News2b"></xsl:apply-templates>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <xsl:template match="News" mode="News2a">
    ...
    <xsl:template match="News" mode="News2b">
         <div class="col-sm-6 col-md-4 col-lg-3">
            <div class="figure-news">
                <div class="figure-image">
                    <div class="wrapper">
